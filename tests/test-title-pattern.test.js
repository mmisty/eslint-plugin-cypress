...
ruleTester.run('@mmisty/cypress/test-title-pattern-jest', rule, {
  valid: [
    {
    ...
    {
      options: [{ pattern: /should/i, message: 'Custom msg' }],
      code: 'it(`test have ${someVar} ' + ' when should template`, () => { })',
    },
    {
      options: [{ pattern: /should/i, message: 'Custom msg' }],
      code:
        'it.only(`test have ${someVar} ' + ' when should template`, () => { })',
    },
    {
      code: "it.only('#1 test', () => { })",
    },
